				...
				<div id="context" class="context" style="height: auto;">
					...
					<div align="center" id="context_text_three">
						...
						<div id="context_text_three2">
							...
							<div class="div_ac">
								<span style="color: red">*</span>&nbsp;年齢：<input type="text" id="userCity2" />&nbsp;&nbsp;&nbsp;
								<span style="color: red">*</span>&nbsp;携帯番号：<input type="text" id="userPhone2"  maxlength="11" />
							</div>
						</div>
					</div>
						...
						<div id="context_text_four2">
							...
							<div class="div_ac" align="center">
								<div class="div_aca">
									...
									<a href="#">
										<b><button id="buyCommodity" class="button">ただちに保険をかける</button></b>
									</a>
								</div>
							</div>
						</div>
